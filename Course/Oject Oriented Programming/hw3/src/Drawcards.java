...
//__Class method:__
void drawingprocess(Player0 p0,Player1 p1,Player2 p2,Player3 p3,Computer pc,Card cd){
//Continue next round if no one wins
//while(p0.numberofhc()!=0||p1.numberofhc()!=0||p2.numberofhc()!=0||p3.numberofhc()!=0)
...
p0.output(cd);
p1.output(cd);
x = pc.checkwinner(p0,p1,p2,p3); //Check if anyone wins after this process
