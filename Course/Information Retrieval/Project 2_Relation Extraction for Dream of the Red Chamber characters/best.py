...
#with open('keywords_FA_W_30_bi.dat',encoding='utf-8') as file:
    for line in file:
        line = line.strip('\n')
...
Count_vectorizer = CountVectorizer(ngram_range=(1, 1), vocabulary = vocab_dict, stop_words=stopword_list)
...
#Random Forest
clf = RandomForestClassifier(n_estimators = 10, #oob_score=True, #class_weight = "balanced",
...
'''
#GBDT
clf = GradientBoostingClassifier(n_estimators = 10, random_state=10, max_depth = 4, learning_rate = 0.1)    
'''
...
#   $Count matrix building$
print('Count vectorizer building...')
Count_vectorizer_test = CountVectorizer(ngram_range=(1, 1), vocabulary = vocab_dict, stop_words=stopword_list)
...
#   $save model$
import pickle 
with open('RF_n_10_d_7_last_name.model', 'wb') as file:
